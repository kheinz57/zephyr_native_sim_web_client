...
Additionaly the web page also shows an image of the front side of the case with all the buttons. The buttons are clicklable and send gpio up and down events. 
